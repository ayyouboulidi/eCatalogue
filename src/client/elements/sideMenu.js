  ...
  render() {
    ...
    return (
      <div className="side_menu">
        ...
        <Link to="/cabin"><div className={(this.state.selected == "cabin") ? "side_menu_box selected" : "side_menu_box"}><img style={cabinStyle} src="/img/CABIN-ICON.png"/><span>Cabin</span></div></Link>
