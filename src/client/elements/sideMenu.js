  ...
  render() {
    return (
      <div className="side_menu">
        ...
        <Link to="" ><div className={(this.state.selected == "favorites") ? "side_menu_box selected" : "side_menu_box"}><img src="/img/FAVOURITE-ICON.png"/><span>My Favorites</span></div></Link>
